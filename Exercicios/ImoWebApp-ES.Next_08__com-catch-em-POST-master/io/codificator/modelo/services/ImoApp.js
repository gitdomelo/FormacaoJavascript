import { Cliente, Imóvel, Evento } from "../../../../codificator.io.js";
//
export default class ImoApp {
	...
	// omitido nesta versão: contar() , enumerarCidades() 

	procurar(predicado) {
		this.encontrados = this.imóveis.filter(predicado);
		if (this.encontrados.length === 0) throw new Error("Não foram encontrados imóveis"); // se houver erro, a linha seguinte não executará
